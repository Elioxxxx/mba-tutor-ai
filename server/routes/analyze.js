...
严格输出JSON：
{
  "studentProfile": {
    ...
    "companyDescription": "企业主营业务描述(限制在50字左右)",
    "personalSummary": "以专业MBA招办视角提炼候选人的核心竞争力、职业转型特点及商科研究潜力（内容要有深度且言之有物，限制在100字以内）。"
  },
...
深度提取核心业务痛点、管理挑战，并推荐论文方向。
严格输出JSON格式：
{
  "studentProfile": {
    "coreBusinessPainPoints": "提炼基于材料分析出的核心业务痛点（限制在100字以内，条理清晰阐述经过分析后的痛点）。",
    "managementChallenges": "提炼企业或候选人面临的核心管理挑战（限制在100字以内综合评述）。"
  },
  "suggestedKeywords": ["论文关键词1", "关键词2", "关键词3", "关键词4", "关键词5"],
  "initialDirection": "推荐论文破解大方向（结合痛点给出具有学术研究价值的MBA论文方向建议，说明切入点，限制在100字以内）。"
}
注意：输出必须是合法且单纯的JSON，不可包含任何外部文字或Markdown框。找不到填"未提及"。`;
